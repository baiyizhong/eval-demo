  ...
  return (
    <div
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:mb-2 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2',
        className
      )}
      {...props}
    />
