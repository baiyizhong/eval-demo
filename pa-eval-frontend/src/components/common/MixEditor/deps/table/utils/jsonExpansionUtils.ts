 ...
 *
 * Migrated from /Users/panpan/Project/eval-demo/langfuse/web/src/components/table/utils/jsonExpansionUtils.ts
 */
...
export function transformJsonToTableData(
  ...
  const entries = Array.isArray(json)
    ? json.map((item, index) => [index.toString(), item] as const)
    : Object.entries(json);
