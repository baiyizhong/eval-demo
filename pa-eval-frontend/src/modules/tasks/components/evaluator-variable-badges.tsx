...
export function EvaluatorVariableBadges({ values }: { values: string[] }) {
  ...
  useEffect(() => {
    ...
    container
      .querySelectorAll<HTMLElement>('[data-evaluator-variable-badge]')
  ...
  return (
    ...
    >
      ...
      >
        <div className='text-xs font-medium'>变量</div>
